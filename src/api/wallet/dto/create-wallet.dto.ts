...
import { IsNotEmpty, IsNumber, IsNumberString, IsString, IsUUID, Length, Matches } from "class-validator"
...
export class CreateWalletDto {
    ...
    @Matches(/^[0-9]{16}$/, { message: 'Karta raqami faqat 16 ta raqamdan iborat bo\'lishi kerak' })
    card: string
}
